/*==============================================================================*/
/*																				*/
/*	@file title	:	cBossRightBattery.cpp										*/
/*  @brief		:	ボス戦艦の右砲台クラス										*/
/*	@written	:	s.kosugi													*/
/*	@create		:   2019/01/19													*/
/*																				*/
...
// コンストラクタ
//==========================================================================================
cBossRightBattery::cBossRightBattery(IBaseObject * parent)
	: cEnemyBase(parent, "BossFiveTube", "data\\graphic\\boss_01_rightBattery.png"),
...
// デストラクタ
//==========================================================================================
cBossRightBattery::~cBossRightBattery(void)
{
}
...
// 初期化
//==========================================================================================
void cBossRightBattery::Initialize(void)
{
...
// 更新
//==========================================================================================
void cBossRightBattery::Update(void)
{
...
// 破棄
//==========================================================================================
IBaseObject* cBossRightBattery::Finalize(void)
{
	cEnemyBase::Finalize();
...
// 待機
//==========================================================================================
void cBossRightBattery::Wait(void)
{
	m_nActionTimer++;
...
// 攻撃
//==========================================================================================
void cBossRightBattery::Attack(void)
{
	m_nBulletTimer++;
...
// 発狂状態待機
//==========================================================================================
void cBossRightBattery::CrazyWait(void)
{
	m_nActionTimer++;
...
// 発狂状態待機
//==========================================================================================
void cBossRightBattery::CrazyAttack(void)
{
	m_nBulletTimer++;
	if (m_nBulletTimer >= SHOOT_INTERVAL)
	{
...
// 追従処理
//==========================================================================================
void cBossRightBattery::MoveFollow(void)
{
...
// 発狂状態への移行チェック
//==========================================================================================
void cBossRightBattery::CheckCrazy(void)
{
	m_nCrazyTimer++;
	// 発狂チェック
