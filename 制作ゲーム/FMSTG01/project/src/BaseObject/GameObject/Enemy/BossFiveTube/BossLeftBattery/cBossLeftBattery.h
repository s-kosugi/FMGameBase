...
//================================================================================================
// ボス戦艦の敵左砲台クラス
class cBossLeftBattery : public cEnemyBase
{
public:
	cBossLeftBattery(IBaseObject* parent);
	~cBossLeftBattery(void);
...
private:
	...
	const int   CRAZY_TIME = 2000;			// 発狂状態への移行タイミング
