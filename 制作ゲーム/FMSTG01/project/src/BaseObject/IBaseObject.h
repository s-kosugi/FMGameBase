...
enum OBJECT_STATE
{
	OBJECT_STATE_WAIT,		//	待機(更新なし、描画のみ)
	OBJECT_STATE_ACTIVE,	//	更新・描画
	OBJECT_STATE_DEAD,		//	死亡(子オブジェクトもすべて解放)
};
...
public:
	...
	// オブジェクトの破棄
	inline void			DeleteObject(void) { m_eObjectState = OBJECT_STATE_DEAD;};
