...
cJoyPad::cJoyPad(void) :
	m_diInputState(nullptr),
	m_diPrevInputState(nullptr),
	m_nJoyPadNum(0)
{
}
...
// コンストラクタ
//==========================================================================================
cJoyPad::cJoyPad(IBaseObject* parent) :
	cJoyPad::cJoyPad()
{
}
...
// コンストラクタ
//==========================================================================================
cJoyPad::cJoyPad(IBaseObject* parent, const std::string& name) :
	cJoyPad::cJoyPad(parent)
{
}
...
// コピーコンストラクタ
//==========================================================================================
cJoyPad::cJoyPad(const cJoyPad& t) :
	cJoyPad::cJoyPad()
{
}
